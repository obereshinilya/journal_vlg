		...
		this.timepicker = {
			...
			clockHolder: {
				...
				buttonsHolder: {
					...
					btnClear: $('<span class="mdtp__button clear-btn">Очистить</span>'),
					btnOk: $('<span class="mdtp__button ok">Установить</span>'),
					btnCancel: $('<span class="mdtp__button cancel">Отменить</span>')
				}
			}
		};
