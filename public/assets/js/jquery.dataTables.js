...
(function(l) {
    ...
    function ma(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && d && "Нет данных" === b.sEmptyTable && X(a, a, "sZeroRecords", "sEmptyTable");
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sInfoEmpty: "Показно 0 строк",
            sInfoFiltered: "(поиск по всем срокам)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Количество строк: _MENU_",
