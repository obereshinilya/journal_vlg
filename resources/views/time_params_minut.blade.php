    ...
    <div style="width: 100%">
        <table style="display: table; width: 100%; table-layout: fixed">
            ...
            <tr>
                ...
                <td><button class="button button1" style="float: right; margin-top: 1%" onclick="localStorage.setItem('to_sut', $('#table_date_start').val()); window.location.href = '/'">К часовым</button></td>
            </tr>
            </tbody>
        </table>
    </div>
