...
<div style="width: 100%">
    <table style="display: table; width: 100%; table-layout: fixed; margin-top: 10px">
        ...
        <tbody>
            <tr>
                ...
                <td><button class="button button1" style="float: right" onclick="localStorage.setItem('to_month', $('#table_date_start').val().slice(0, -3));  window.location.href = '/sut'">К суточным</button></td>
                <td><button class="button button1" style="float: right; margin-right: 130px" onclick="open_modal_export_ober()">Экспорт</button></td>
            </tr>
        </tbody>
    </table>
</div>
    ...
    <div id="tableDiv">
        <table id="statickItemInfoTable" class="itemInfoTable" style="width: 25%; float:left; direction:rtl; table-layout: fixed">
            <thead>
            <tr>
                <th class="objCell" style="width: 2%; padding-left: 0px; padding-right: 0px; text-align: center; z-index: 2"><h4>Ед. изм</h4></th>
        ...
        <table id="itemInfoTable" class="itemInfoTable" style="width: 74%; float:left">
            <thead>
                <tr>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="10:00" oncontextmenu="all_param_accepted(this)" data-time-id="1">
                        <h4>10:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="11:00" oncontextmenu="all_param_accepted(this)" data-time-id="2">
                        <h4>11:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="12:00" oncontextmenu="all_param_accepted(this)" data-time-id="3">
                        <h4>12:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="13:00" oncontextmenu="all_param_accepted(this)" data-time-id="4">
                        <h4>13:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="14:00" oncontextmenu="all_param_accepted(this)" data-time-id="5">
                        <h4>14:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="15:00" oncontextmenu="all_param_accepted(this)" data-time-id="6">
                        <h4>15:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="16:00" oncontextmenu="all_param_accepted(this)" data-time-id="7">
                        <h4>16:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="17:00" oncontextmenu="all_param_accepted(this)" data-time-id="8">
                        <h4>17:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="18:00" oncontextmenu="all_param_accepted(this)" data-time-id="9">
                        <h4>18:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="19:00" oncontextmenu="all_param_accepted(this)" data-time-id="10">
                        <h4>19:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="20:00" oncontextmenu="all_param_accepted(this)" data-time-id="11">
                        <h4>20:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="21:00" oncontextmenu="all_param_accepted(this)" data-time-id="12">
                        <h4>21:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="22:00" oncontextmenu="all_param_accepted(this)" data-time-id="13">
                        <h4>22:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="23:00" oncontextmenu="all_param_accepted(this)" data-time-id="14">
                        <h4>23:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="00:00" oncontextmenu="all_param_accepted(this)" data-time-id="15">
                        <h4>00:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="01:00" oncontextmenu="all_param_accepted(this)" data-time-id="16">
                        <h4>01:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="02:00" oncontextmenu="all_param_accepted(this)" data-time-id="17">
                        <h4>02:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="03:00" oncontextmenu="all_param_accepted(this)" data-time-id="18">
                        <h4>03:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="04:00" oncontextmenu="all_param_accepted(this)" data-time-id="19">
                        <h4>04:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="05:00" oncontextmenu="all_param_accepted(this)" data-time-id="20">
                        <h4>05:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="06:00" oncontextmenu="all_param_accepted(this)" data-time-id="21">
                        <h4>06:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="07:00" oncontextmenu="all_param_accepted(this)" data-time-id="22">
                        <h4>07:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="08:00" oncontextmenu="all_param_accepted(this)" data-time-id="23">
                        <h4>08:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                    <th  class="timeCell" onclick="goToHour(this)" style="width: 4%" data-time="09:00" oncontextmenu="all_param_accepted(this)" data-time-id="24">
                        <h4>09:00
                            <img src="assets/images/icons/accept_ober.png" style="height: 14px; display: none"/>
                        </h4>
                    </th>
                                    ...
                                    if (Boolean(row[id]['manual'])===true){
                                        tr.innerHTML += `<td data-time-id="${id}" class="hour-value-${row['hfrpok']}" data-time="${row[id]['timestamp']}" style="background-color: indianred" ><span contenteditable="true" class="changeable_td tooltip" numbercolumn="${id}" style="background-color: indianred" data-column="val" data-row-id="${row[id]['id']}"  spellcheck="false" data-type="float" data-title="Изменил: ${row[id]['change_by']}">${row[id]['val']}</span></td>`
                                            ...
                                            if (accept_ids.includes(id)){
                                                if(row[id]['change_by'] != ''){
                                                tr.innerHTML += `<td data-time-id="${id}" class="hour-value-${row['hfrpok']}" data-time="${row[id]['timestamp']}"><span contenteditable="false" class="changeable_td tooltip" numbercolumn="${id}" style="background-color: rgba(0, 0, 0, 0)" data-column="val" data-row-id="${row[id]['id']}"  spellcheck="false" data-type="float" data-title="${row[id]['change_by']}" >${row[id]['val']}</span></td>`
                                                }else{
                                                tr.innerHTML += `<td data-time-id="${id}" class="hour-value-${row['hfrpok']}" data-time="${row[id]['timestamp']}"><span class="changeable_td" contenteditable="false" style="background-color: rgba(0, 0, 0, 0)" oncopy="return false" numbercolumn="${id}" oncut="return false" onpaste="return false" data-column="val" data-row-id="${row[id]['id']}"  spellcheck="false" data-type="float">${row[id]['val']}</span></td>`
                                                }
                                            } else {
                                                if(row[id]['change_by'] != ''){
                                                tr.innerHTML += `<td data-time-id="${id}" class="hour-value-${row['hfrpok']}" data-time="${row[id]['timestamp']}"><span contenteditable="true" class="changeable_td tooltip" numbercolumn="${id}" style="background-color: rgba(0, 0, 0, 0)" data-column="val" data-row-id="${row[id]['id']}"  spellcheck="false" data-type="float" data-title="${row[id]['change_by']}" >${row[id]['val']}</span></td>`
                                                }else{
