                    ...
                    for (var row of res) {
                        ...
                        for (var id = 1; id <= Object.keys(row).length -4; id++) {
                            if (!index_thead){
                                ...
                                tr_thead.innerHTML += `<th  class="timeCell" onclick="goToDay(${id})" style="width: 2%; text-align: center" data-time-id="${id}" oncontextmenu="all_param_accepted(this)" ><h4>${day+'.'+month} <img src=\"assets/images/icons/accept_ober.png\" style="height: 14px; display: none"/> </h4></th>`
                            }
                            if (row[id]['id']) {
