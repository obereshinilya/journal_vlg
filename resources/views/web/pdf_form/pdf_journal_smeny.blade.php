...
@if(isset($date))
    ...
    <div id="redirect">
        ...
        <div class="tableDiv_{{$date}}" style="width: 100%; font-size: 14px">
...
<script>
    ...
    function get_tds() {
        ...
        if (document.getElementById('date') != null) {
            date.push(document.getElementById('date').textContent)
        } else {
            document.querySelectorAll('.date').forEach((el) => {
                date.push(el.textContent);
            })
        }
        date.forEach((el) => {
            $.ajax({
                ...
                success: function (tds) {
                    for (var td of tds) {
                        try {
                            var one_td = document.querySelector('.tableDiv_' + el + ' #' + td['id_record'])
