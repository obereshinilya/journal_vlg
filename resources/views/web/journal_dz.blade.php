                ...
                success: (res) => {
                    ...
                    for (var i = 0; i < res.length; i++) {
                        ...
                        if (res[i]['check']) {
                            ...
                            tr.innerHTML += `<td style="text-align: center; font-size:${14 * localStorage.getItem('font')}px"><button class="button button1" onclick="confirm_dz(${res[i]['id']})">Принять задание</button></td>`
                        }
